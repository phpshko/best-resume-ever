...
<div class="resume">
  <div class="leftCol m_box">
    ...
    <a v-if="person.contact.linkedin" :href="'https://www.linkedin.com/in/' + person.contact.linkedin" target="_blank">
      <div class="item">
        <div class="icon">
  ...
  <div class="rightCol">
    ...
    <div class="block" v-for="experience in person.experience" :key="experience.company">
      ...
      :href="experience.website">
        ...
        <h3 class="headline">{{experience.company}} - {{experience.position}}</h3>
